...
void math() {
	cout << "\tpublic static Method testDsqrt:\"(D)D\"\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testIabs:\"(I)I\"\n"
					"\t\tstack 1 locals 1\n"
					"\t{\n"
					"\t\tiload_0;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testLabs:\"(J)J\"\n"
					"\t\tstack 2 locals 2\n"
					"\t{\n"
					"\t\tlload_0;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testImax:\"(II)I\"\n"
					"\t\tstack 2 locals 2\n"
					"\t{\n"
					"\t\tiload_0;\n"
					"\t\tiload_1;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testLmax:\"(JJ)J\"\n"
					"\t\tstack 4 locals 4\n"
					"\t{\n"
					"\t\tlload_0;\n"
					"\t\tlload_2;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testFmax:\"(FF)F\"\n"
					"\t\tstack 2 locals 2\n"
					"\t{\n"
					"\t\tfload_0;\n"
					"\t\tfload_1;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testDmax:\"(DD)D\"\n"
					"\t\tstack 4 locals 4\n"
					"\t{\n"
					"\t\tdload_0;\n"
					"\t\tdload_2;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testImin:\"(II)I\"\n"
					"\t\tstack 2 locals 2\n"
					"\t{\n"
					"\t\tiload_0;\n"
					"\t\tiload_1;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testLmin:\"(JJ)J\"\n"
					"\t\tstack 4 locals 4\n"
					"\t{\n"
					"\t\tlload_0;\n"
					"\t\tlload_2;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testFmin:\"(FF)F\"\n"
					"\t\tstack 2 locals 2\n"
					"\t{\n"
					"\t\tfload_0;\n"
					"\t\tfload_1;\n"
					...
					"\t}\n"
					"\n"
					"\tpublic static Method testDmin:\"(DD)D\"\n"
					"\t\tstack 4 locals 4\n"
					"\t{\n"
					"\t\tdload_0;\n"
					"\t\tdload_2;\n"
