...
inline void Assembler::store_RV(Register s, Register base, int width, int off) { emit_int32(STORE_RV_OPCODE | rs1(base) | rs2(s) | funct3(width) | imms(off)); }
inline void Assembler::store_fp_RV(FloatRegister s, Register base, int width, int off) { emit_int32(STORE_FP_RV_OPCODE | rs1(base) | rs2(s) | funct3(width) | imms(off)); }
...
inline void Assembler::sd_RV(Register s, Register base, int off) { store_RV(s, base, 0x3, off); }
inline void Assembler::sw_RV(Register s, Register base, int off) { store_RV(s, base, 0x2, off); }
inline void Assembler::sh_RV(Register s, Register base, int off) { store_RV(s, base, 0x1, off); }
inline void Assembler::sb_RV(Register s, Register base, int off) { store_RV(s, base, 0x0, off); }
...
inline void Assembler::fsw_RV(     FloatRegister s, Register base, int imm) { store_fp_RV(s, base, 0x2, imm); }
...
inline void Assembler::fsd_RV(     FloatRegister s, Register base, int imm) { store_fp_RV(s, base, 0x3, imm); }
...
inline void Assembler::fsq_RV(     FloatRegister s, Register base, int imm) { store_fp_RV(s, base, 0x4, imm); }
