...
void VM_Version_Ext::initialize_cpu_information(void) {
  ...
  snprintf(_cpu_name, CPU_TYPE_DESC_BUF_SIZE, "PowerPC POWER%lu", PowerArchitectureRISCV64);
  snprintf(_cpu_desc, CPU_DETAILED_DESC_BUF_SIZE, "RISCV %s", features_string());
  _initialized = true;
}
